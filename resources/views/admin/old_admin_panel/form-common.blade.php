...
<script src="{{env('PUBLIC_PATH')}}/admin_resources/js/bootstrap-colorpicker.js"></script> 
<script src="{{env('PUBLIC_PATH')}}/admin_resources/js/bootstrap-datepicker.js"></script> 
<script src="{{env('PUBLIC_PATH')}}/admin_resources/js/jquery.toggle.buttons.js"></script> 
<script src="{{env('PUBLIC_PATH')}}/admin_resources/js/masked.js"></script> 
...
<script src="{{env('PUBLIC_PATH')}}/admin_resources/js/matrix.form_common.js"></script> 
<script src="{{env('PUBLIC_PATH')}}/admin_resources/js/wysihtml5-0.3.0.js"></script> 
<script src="{{env('PUBLIC_PATH')}}/admin_resources/js/jquery.peity.min.js"></script> 
<script src="{{env('PUBLIC_PATH')}}/admin_resources/js/bootstrap-wysihtml5.js"></script> 
<script>
